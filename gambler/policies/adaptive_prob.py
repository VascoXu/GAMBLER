...
class AdaptiveProb(AdaptiveLiteSense):
    ...
    def policy_type(self) -> PolicyType:
        return PolicyType.ADAPTIVE_PROB
    ...
    def update(self, collection_ratio: float, seq_idx: int, window: tuple):
        ...
        # Flip a coin to decide which policy to use
        ...
        if rand < alpha:
            ...
            collection_rate = budget_left if budget_left < 1 else 1.0
