...
if __name__ == '__main__':
    ...
    policies = ['uniform', 'adaptive_gambler']
    ...
    for dataset in args.datasets:
        ...
        for i in range(NUM_RUNS):
            ...
            savings_map[dataset]['uniform'].append([budget, uniform_samples, uniform_mae])
            ...
            for policy_name in policies[1:]:
                ...
                # accuracy to uniform.
                while (iter_count < MAX_ITER) and (abs(int(lower) - int(upper)) > 1):
                    ...
                    if args.should_print:
                        print(f'Best MAE: {mae:0.5f} | Best Collected: {num_collected}, Best Budget: {current}', end='\r')
                
                savings_map[dataset][policy_name].append([budget, num_collected, mae])
                if args.should_print:
                    print('\n==========')
